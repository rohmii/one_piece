	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity.getPersistentData().getBoolean("makami") == true) {
			if (!(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersEntityRenderer) && _evt.getEntity() instanceof Mob) {
				...
				new com.kleiders.kleidersplayerrenderer.KleidersEntityRenderer(context, new ResourceLocation("one_piece:textures/entities/makami.png"), new Modelmakami(context.bakeLayer(Modelmakami.LAYER_LOCATION))).render((Mob) _evt.getEntity(),
