...
import net.mcreator.onepiece.item.MakamiFruitItem;
...
public class OnePieceModItems {
	...
	public static final RegistryObject<Item> MAKAMI_FRUIT = REGISTRY.register("makami_fruit", () -> new MakamiFruitItem());
