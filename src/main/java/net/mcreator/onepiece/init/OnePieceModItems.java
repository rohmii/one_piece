...
public class OnePieceModItems {
	...
	public static final RegistryObject<PortgasDAceHatItem> PORTGAS_D_ACE_HAT_HELMET = REGISTRY.register("portgas_d_ace_hat_helmet", () -> new PortgasDAceHatItem(ArmorItem.Type.HELMET, new Item.Properties()));
