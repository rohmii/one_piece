...
public class Modelpistol_5<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("one_piece", "modelpistol_5"), "main");
	...
	public Modelpistol_5(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition part2 = rotation.addOrReplaceChild("part2",
				CubeListBuilder.create().texOffs(40, 21).addBox(-8.0F, -24.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 21).addBox(-8.0F, -25.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 21)
						...
						.addBox(-8.0F, -21.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition part4 = rotation.addOrReplaceChild("part4",
				CubeListBuilder.create().texOffs(40, 23).addBox(-8.0F, -23.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 23).addBox(-8.0F, -21.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 23)
						.addBox(-8.0F, -20.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 23).addBox(-8.0F, -22.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 23)
		...
		PartDefinition part5 = rotation.addOrReplaceChild("part5",
				CubeListBuilder.create().texOffs(40, 24).addBox(-8.0F, -23.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 24).addBox(-8.0F, -22.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 24)
						.addBox(-8.0F, -21.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 24).addBox(-8.0F, -24.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 24)
						.addBox(-8.0F, -25.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 49.0F, 0.0F));
		PartDefinition part6 = rotation.addOrReplaceChild("part6",
				CubeListBuilder.create().texOffs(40, 25).addBox(-8.0F, -15.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 25).addBox(-8.0F, -13.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 25)
