...
public class Modelpistol_4<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("one_piece", "modelpistol_4"), "main");
	...
	public Modelpistol_4(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition part1 = rotation.addOrReplaceChild("part1",
				CubeListBuilder.create().texOffs(40, 20).addBox(-8.0F, -24.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 20).addBox(-8.0F, -22.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 20)
		...
		PartDefinition part2 = rotation.addOrReplaceChild("part2",
				CubeListBuilder.create().texOffs(40, 21).addBox(-8.0F, -24.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 21).addBox(-8.0F, -25.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 21)
						.addBox(-8.0F, -23.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 21).addBox(-8.0F, -22.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition part6 = rotation.addOrReplaceChild("part6",
				CubeListBuilder.create().texOffs(40, 25).addBox(-8.0F, -15.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 25).addBox(-8.0F, -14.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 25)
						.addBox(-8.0F, -16.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 25).addBox(-8.0F, -17.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 41.0F, 0.0F));
