...
public class StrawHatItem extends ArmorItem implements GeoItem {
	...
	public StrawHatItem(ArmorItem.Type type, Item.Properties properties) {
	...
	private PlayState predicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.den_den_mushi.animation.idle"));
